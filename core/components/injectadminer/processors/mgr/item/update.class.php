 ...
 * Update an Item
 */
class injectAdminerItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('injectadminer_item_err_ns');
		}
...
return 'injectAdminerItemUpdateProcessor';
